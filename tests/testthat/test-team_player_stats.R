...
suppressWarnings(neb2023 <- team_player_stats("558878"))
...
test_that("player_stats works properly", {
  ...
  expect_error(team_player_stats(585290), "Team ID must be a character string.")
  expect_error(team_player_stats("Nebraska"), "Team ID was not found in the list of valid IDs.")
})
