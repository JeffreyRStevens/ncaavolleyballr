test_that("conference_stats() works", {
  ...
  expect_error(group_stats(teams = "Nebraska", year = 2024, level = "xxx"),
               "Enter valid level")
  expect_error(conference_stats(year = 2024, conf = "Big Ten", level = "season", sport = "VB"),
               "Enter valid sport")
  expect_error(conference_stats(year = 2024, conf = "Big Ten", level = "season", save = "TRUE"),
               "`save` must be a logical")
  expect_error(conference_stats(year = 2024, conf = "Big Ten", level = "season", path = 3),
